...
export class pen_t {
  ...
  world_space(screen_pos)
  {
    return new vec2_t(
      (screen_pos.x - this.canvas.width / 2.0) / (this.canvas.width * this.aspect_ratio / 2.0),
      -(screen_pos.y - this.canvas.height / 2.0) / (this.canvas.height / 2.0)
    );
  }
